...
namespace EnglishGame
{
    public partial class Animal : Form
    {
        ...
        public string[] animals = { "cat", "dog", "fox", "giraffe", "lion", "horse", "leopard", "monkey", "rabbit", "rhino", "squirrel", "tiger" };
        ...
        private void Animal_Load(object sender, EventArgs e)
        {
            ...
            pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Animal\\" + animals[randomValue[0]] + ".png");
        ...
        private void showAnswer()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                dt2.Rows.Add(i + 1, animals[randomValue[i]], userAnswer[i], Image.FromFile(path + "\\Resources\\" + checkUserAnswer[i] + ".png"), Image.FromFile(path + "\\Resources\\Animal\\" + animals[randomValue[i]] + "_small.png"));
            }
        ...
        private void textBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter)
            {
                if (textBox.Text != "" && textBox.Text != null)
                {
                    ...
                    if (textBox.Text.ToLower() == animals[randomValue[countSubmit]])
                    {
                        Global.correctSound();
                    ...
                    if (countSubmit < 9)
                    {
                        countSubmit++;
                        question.Text = (countSubmit + 1).ToString() + "/10";
                        pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Animal\\" + animals[randomValue[countSubmit]] + ".png");
                    }
                    else
                    {
                        ...
                        string data = point.Text.Split('/')[0] + ";" + time.Text + ";" + "animal";
