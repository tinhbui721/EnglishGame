...
namespace EnglishGame
{
    public partial class Clothes : Form
    {
        ...
        public string[] clothes = { "cap", "dress", "dressing gown", "jacket", "jeans", "jumper", "pyjamas", "raincoat", "skirt", "sneakers", "socks", "t shirt" };
        ...
        public Clothes(WindowsMediaPlayer play)
        {
            InitializeComponent();
            player_parent = play;
        }
        ...
        private void showAnswer()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                dt2.Rows.Add(i + 1, clothes[randomValue[i]], userAnswer[i], Image.FromFile(path + "\\Resources\\" + checkUserAnswer[i] + ".png"), Image.FromFile(path + "\\Resources\\Clothes\\" + clothes[randomValue[i]].Replace(" ", "_") + "_small.png"));
            }
        ...
        private void button_Click(object sender, EventArgs e)
        {
            if (textBox.Text != "" && textBox.Text != null)
            {
                ...
                if (textBox.Text.ToLower() == clothes[randomValue[countSubmit]])
                {
                    Global.correctSound();
                ...
                if (countSubmit < 9)
                {
                    ...
                    pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Clothes\\" + clothes[randomValue[countSubmit]].Replace(" ", "_") + ".png");
                }
                else
                {
                    ...
                    string data = point.Text.Split('/')[0] + ";" + time.Text + ";" + "clothes";
        ...
        private void Clothes_Load(object sender, EventArgs e)
        {
            ...
            point.Text = pointCount.ToString() + "/100";
            question.Text = (countSubmit + 1).ToString() + "/10";
            pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Clothes\\" + clothes[randomValue[0]].Replace(" ", "_") + ".png");
