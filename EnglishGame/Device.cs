...
namespace EnglishGame
{
    public partial class Device : Form
    {
        ...
        public string[] devices = { "camera", "clock", "computer", "fan", "head phone", "laptop", "mobile phone", "printer", "projector", "scanner", "speaker", "watch" };
        ...
        public Device(WindowsMediaPlayer play)
        {
            InitializeComponent();
            player_parent = play;
        }
        ...
        private void showAnswer()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                dt2.Rows.Add(i + 1, devices[randomValue[i]], userAnswer[i], Image.FromFile(path + "\\Resources\\" + checkUserAnswer[i] + ".png"), Image.FromFile(path + "\\Resources\\Device\\" + devices[randomValue[i]].Replace(" ", "_") + "_small.png"));
            }
        ...
        private void button_Click(object sender, EventArgs e)
        {
            if (textBox.Text != "" && textBox.Text != null)
            {
                ...
                if (textBox.Text.ToLower() == devices[randomValue[countSubmit]])
                {
                    Global.correctSound();
                ...
                if (countSubmit < 9)
                {
                    ...
                    pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Device\\" + devices[randomValue[countSubmit]].Replace(" ", "_") + ".png");
                }
                else
                {
                    ...
                    string data = point.Text.Split('/')[0] + ";" + time.Text + ";" + "device";
        ...
        private void Device_Load(object sender, EventArgs e)
        {
            ...
            point.Text = pointCount.ToString() + "/100";
            question.Text = (countSubmit + 1).ToString() + "/10";
            pictureBox.BackgroundImage = Image.FromFile(path + "\\Resources\\Device\\" + devices[randomValue[0]].Replace(" ", "_") + ".png");
